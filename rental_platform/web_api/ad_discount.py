...
def update_additional_discount(
    quotation_name,
    ...
    original_total = (
        quotation.total
        or quotation.base_total
        or quotation.net_total
        or quotation.base_net_total
    )
    ...
    additional_discount_amount = (
        float(additional_discount_amount)
    ...
    if additional_discount_percentage is not None:
        ...
        quotation.grand_total = (
            original_total - additional_discount_amount
        )
